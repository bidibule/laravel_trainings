<div class="content-header-section">
    ...
    <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-dropdown">
            ...
            <a class="dropdown-item" href="#" onclick="document.logout.submit()">
                                    <i class="si si-logout mr-5"></i> Sign Out
                                </a>
            <form name="logout" id="logout" method="POST" action="{{ route('logout') }}">
                @csrf
            </form>
        </div>
    </div>
    ...
    <!-- Notifications -->
    <div class="btn-group" role="group">
        <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-notifications" data-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
