...
<div class="kt-portlet kt-portlet--height-fluid-">
    <div class="kt-portlet__head kt-portlet__head--noborder">
        ...
        <div class="kt-portlet__head-toolbar">
            ...
            <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(325px, 46px, 0px);">
                <ul class="kt-nav">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="kt-section kt-section--space-md">
                    <div class="kt-widget24 kt-widget24--solid">
                        ...
                        <div class="progress progress--sm">
                            <div class="progress-bar kt-bg-success" role="progressbar" style="width: 45%;" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                ...
                <div class="kt-section kt-section--last">
                    <a href="#" class="btn btn-label-brand btn-sm btn-bold"><i class=""></i> See all deals</a>
                </div>
            </div>
        </div>
        <!--End:: Portlet-->
...
<div class="kt-portlet kt-portlet--height-fluid">
	<div class="kt-portlet__head">
		...
		<div class="kt-portlet__head-toolbar">
			...
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(470px, 46px, 0px);">
                <!--begin::Nav-->
<ul class="kt-nav">
    <li class="kt-nav__head">
        Export Options                                    
...
<div class="kt-portlet kt-portlet--bordered-semi kt-portlet--height-fluid">
	<div class="kt-portlet__head">
		...
		<div class="kt-portlet__head-toolbar">
			...
			<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(470px, 46px, 0px);">
				<ul class="kt-nav">
	...
	<div class="kt-portlet__head">
		...
		<div class="kt-portlet__head-toolbar">
			<div class="dropdown dropdown-inline">
				...
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(32px, 0px, 0px);">
                    <!--begin::Nav-->
<ul class="kt-nav">
    <li class="kt-nav__head">
        Export Options                                    
...
<div class="kt-portlet kt-portlet--height-fluid">
	<div class="kt-portlet__head">
		...
		<div class="kt-portlet__head-toolbar">
			<ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
				<li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#kt_widget6_tab1_content" role="tab" aria-selected="false">
						Latest
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link active" data-toggle="tab" href="#kt_widget6_tab3_content" role="tab" aria-selected="true">
						Month
					</a>
				</li>
			</ul>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M12,4.25932872 L12,18 L7.91561963,20.1472858 C7.42677504,20.4042866 6.82214789,20.2163401 6.56514708,19.7274955 C6.46280801,19.5328351 6.42749334,19.309867 6.46467018,19.0931094 L7.24471742,14.545085 L3.94038429,11.3241562 C3.54490071,10.938655 3.5368084,10.3055417 3.92230962,9.91005817 C4.07581822,9.75257453 4.27696063,9.65008735 4.49459766,9.61846284 L9.06107374,8.95491503 L11.1032639,4.81698575 C11.277344,4.464261 11.6315987,4.25960807 12,4.25932872 Z" id="Combined-Shape" fill="#000000"></path>
            ...
            <div class="tab-pane active" id="kt_widget6_tab3_content" aria-expanded="false">
                <div class="kt-notification">
                    <a href="#" class="kt-notification__item">
                        <div class="kt-notification__item-icon">
